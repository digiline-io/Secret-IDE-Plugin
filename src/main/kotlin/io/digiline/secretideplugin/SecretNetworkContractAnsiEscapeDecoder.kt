...
class SecretNetworkContractAnsiEscapeDecoder : AnsiEscapeDecoder() {
  ...
  companion object {
    private const val CSI: String = "\u001B[" // "Control Sequence Initiator"
    ...
    private const val ANSI_24_BIT_COLOR_FORMAT: Int = 2
    private const val ANSI_8_BIT_COLOR_FORMAT: Int = 5
